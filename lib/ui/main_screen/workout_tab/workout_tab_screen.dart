    ...
    return ViewModelBuilder<WorkoutTabViewModel>.reactive(
        ...
        builder: (context, model, child) => Column(children: [
              ...
              ChangeDateButtons(handleOnPressedLeftButton: (() async {
                ...
                await model.loadData(widget.date);
                widget
                    .handleOnPressedDateButton(ChangeDateButtonTypeEnum.middle);
                EasyLoading.dismiss(animation: false);
                ...
                await model.loadData(widget.date);
                widget
                    .handleOnPressedDateButton(ChangeDateButtonTypeEnum.right);
                EasyLoading.dismiss(animation: false);
              })),
              Padding(
                            ...
                            return Slidable(
                                ...
                                endActionPane: ActionPane(
                                  ...
                                  children: [
                                    SlidableAction(
                                        onPressed: (BuildContext context) =>
                                            model.openWorkoutScreen(
                                                context, workout.id ?? 0),
                                        backgroundColor:
